...
class TermConditionsAgreeModel {
  final String title;
  final String content;

  TermConditionsAgreeModel({
    required this.title,
    required this.content,
  });
}

class TermConditionsAgreeDetailScreen extends StatelessWidget {
  ...
  TermConditionsAgreeDetailScreen({Key? key}) : super(key: key);
